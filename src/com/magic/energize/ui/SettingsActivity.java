...
import com.magic.energize.fragments.ConnectAccountsFragment;
import com.magic.energize.fragments.HouseholdSettingsFragment;
    	...
    	confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		    	...
		    	if(prefs.getString(getString(R.string.login_token), null) != null) {
		    		...
		    		data.putString("token", prefs.getString(getString(R.string.login_token), null));
		    		...
		    		editor.putString(getString(R.string.gas_id), gas_id.getText().toString());
		    		editor.putString(getString(R.string.gas_pass), gas_password.getText().toString());
		    		editor.commit();
    	...
    	confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		    	...
		    	if(prefs.getString(getString(R.string.login_token), null) != null) {
		    		...
		    		// Add gas account details to preferences
		    		SharedPreferences.Editor editor =  prefs.edit();
		    		editor.putString(getString(R.string.elec_id), elec_id.getText().toString());
		    		editor.putString(getString(R.string.elec_pass), elec_password.getText().toString());
		    		editor.commit();
		    		mDialog = ProgressDialog.show(SettingsActivity.this, "", 
			                "Registering account. One moment please...", true);
		    	} else {
